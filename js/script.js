...
for (var i = 0; i < numberOfSpots-1; i += 1) {

  var rippleId = 'ripple' + i;
  var rippleSelector = '#ripple' + i;
  var ripplePerUnitTimeFactor = travelersPerStation[i];

  console.log(rippleId + rippleSelector + ripplePerUnitTimeFactor);

  setInterval(function(){

    $(rippleSelector).animate({
      opacity: '0.0',
      height: '2000px',
      width: '2000px',
    }, 1500);
